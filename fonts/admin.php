...
<div class="wrapper123">
		...
		<form action="login.php" method="post" class="login">
			...
			<div class="login-container">
				<label>Usuario</label>
				<input name="usu_form" id="usu_form" type="text" placeholder="Ingresar Usuario">
				
				<label>Contraseña</label>
				<input name="pass_form" id="pass_form" type="password" placeholder="Ingresar Contraseña">
	...
	<br>
	<br>
	Esta página fue creada por los estudientes de Esis
	</div>
