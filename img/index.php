...
<body>
    ...
    <div class="brand">UNIVERSIDAD NACIONAL JORGE BASADRE GROHMANN</div>
            ...
            <div id="cuerpo">
                <form id="form-login" action="login.php" method="post" ><!--autocomplete="off"-->
                    ...
                    <p><label >Usuario:</label></p>
                        <input name="usu_form" type="text" id="usu_form" placeholder="Ingresa Usuario" autofocus="" required=""></p>

                    <p><label>Contraseña:</label></p>
                        <input name="pass_form" type="password" id="pass_form" placeholder="Ingresa Contraseña" required=""></p>
