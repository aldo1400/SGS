<?php if(isset($_POST["docente_id"]))
  {
      ...
      $query="SELECT * FROM asignatura WHERE cod_asignatura='".$_POST["docente_id"]."' ";
      ...
      <div class="form-row">
          ...
          <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control" name="nombre_edita" id="nombre_edita" placeholder="Last name" value="'.$row["ciclo_academico"].'" required disabled="true" >
