...
<div id="menu">
 ...
 <br>
  ...
  <li><a href="administrador.php" title=""><img src="img/agregar_docente.png" width="40" height="40">Crear docente</a></li>
     ...
     <?php
      ...
      <div id="menu">
       <ul>
        ...
        <li><a href="revisa_docente.php?nombre_profesor=<?php echo $nombre ?>"><img src="img/flecha.png" width="30" height="30">Ing.<?php echo $nombre; ?></a></li>
        </ul>
      </div>
...
<?php
      $consulta ="SELECT * FROM docente where nombre='$nombre_profesor'";
      $ejecutar= mysqli_query($con,$consulta);
...
echo "</form>";
    ...
    <div class="contentform">
		...
		<div class="form-group">
			<p>Codigo docente <span>*</span></p>
			<span class="icon-case"><img src="img/codigo.png" height="15"><i class="fa fa-comment-o"></i></span>
                <input type="text" name="codigo_crea" id="codigo_crea" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Sujet' doit être renseigné." value="<?php echo $row[0] ?>"/>
                <div class="validation"></div>
			</div>
            ...
            <p>Nombres <span>*</span></p>
            <span class="icon-case"><img src="img/male.png" height="15"><i class="fa fa-user"></i></span>
				<input type="text" name="nombres_crea" id="nombres_crea" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Prénom' doit être renseigné." value="<?php echo $row[1] ?>"/>
                <div class="validation"></div>
			</div>
			      ...
			      <div class="form-group">
			        <p>Apellidos<span>*</span></p>
			        <span class="icon-case"><img src="img/male.png" height="15"><i class="fa fa-male"></i></span>
				        <input type="text" name="apellidos_crea" id="apellidos_crea" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Nom' doit être renseigné." value="<?php echo $row[2] ?>"/>
                <div class="validation"></div>
       </div>
			...
			<p>DNI <span>*</span></p>
			<span class="icon-case"><img src="img/dni.svg" height="18"><i class="fa fa-home"></i></span>
				<input type="text" name="dni_crea" id="dni_crea" data-rule="maxlen:8" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Société' doit être renseigné." value="<?php echo $row[3] ?>"/>
                <div class="validation"></div>
			</div>
			...
			<p>Dirección <span>*</span></p>
			<span class="icon-case"><img src="img/direccion_fisica.png" height="15"><i class="fa fa-location-arrow"></i></span>
				<input type="text" name="direccion_crea" id="direccion_crea" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Adresse' doit être renseigné." value="<?php echo $row[4] ?>" />
                <div class="validation"></div>
			</div>
			...
			<span class="icon-case"><img src="img/tipo_usuario.png" height="18"><i class="fa fa-phone"></i></span>
				...
				<input type="text" name="tipo_crea" id="tipo_crea" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Ville' doit être renseigné." value="<?php echo $row[5] ?> "/>
                <div class="validation"></div>
			</div>
			...
			<p>E-mail <span>*</span></p>
			<span class="icon-case"><img src="img/message_icon.png" height="15"><i class="fa fa-envelope-o"></i></span>
                <input type="email" name="email_crea" id="email_crea" data-rule="email" data-msg="Vérifiez votre saisie sur les champs : Le champ 'E-mail' est obligatoire." value="<?php echo $row[6] ?>"/>
                <div class="validation"></div>
			</div>
	...
	<div class="rightcontact">
			...
			<p>Fecha Nacimiento <span>*</span></p>
			<span class="icon-case"><img src="img/nacimiento.png" height="18"><i class="fa fa-map-marker"></i></span>
				<input type="text" name="fecha_nacimiento_crea" id="fecha_nacimiento_crea" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Code postal' doit être renseigné." value="<?php echo $row[7] ?>"/>
                <div class="validation"></div>
			</div>
			...
			<span class="icon-case"><img src="img/contraseña.png" height="15"><i class="fa fa-building-o"></i></span>
				<input type="text" name="password_crea" id="password_crea" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Ville' doit être renseigné." value="<?php echo $row[8] ?>" />
                <div class="validation"></div>
			</div>
