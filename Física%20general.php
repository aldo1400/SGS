...
<div class="wrapper123">
 ...
 <BR>
  ...
  <li><a href="admin.php" title=""><img src="img/flecha.png" width="30" height="30">Mi perfil</a></li>
  <li><a href="#" title=""><img src="img/flecha.png" width="30" height="30">Asignaturas</a></li>
 </ul>
</div>
...
<?php
      $consulta ="SELECT * FROM asignatura where nomb_asignatura='Física General'";
      $ejecutar= mysqli_query($con,$consulta);
      $i=0;
      while($fila = mysqli_fetch_array($ejecutar))
      {
...
<img src="img/profesor.jpg" width="200" height="200" align="RIGHT">
<p>DATOS PERSONALES<p>
<br><p>NOMBRE DEL DOCENTE:<p>
<br><p>CATEGORIA DEL DOCENTE:<p>
<br><p>CORREO DEL PROFESOR:<p>
